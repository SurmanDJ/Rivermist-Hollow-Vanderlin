...
<<<<<<< HEAD
		button.maptext = MAPTEXT_CENTER("<span style='font-family: \"Blackmoor LET\", \"Mookmania\";font-size: 150%;text-shadow: 1px 1px 2px black, 0 0 1em black, 0 0 0.2em black;'>BUTTON: [26-i]</span>")
=======
